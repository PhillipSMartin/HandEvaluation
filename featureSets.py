...
'balanced' : # 4333, 4432, or 5332
    { 'feature_names' : ['AK',
     ...
     'fixed_features' : list(range(0,73)) + [106],         # features for which we do not wish to adjust the weights
     'features_ordered_by_high_cards': [range(4, -1, -1),
        range(8, 4, -1),
        range(11, 8, -1),
        range(15, 11, -1),
    ...
    'features_ordered_by_length' : [[0, 19, 48, 80],
     ...
     'default_vectors' : pd.DataFrame({ 'Vector': [[14, 12, 10, 8, 8, 10, 8, 6, 6, 6, 4, 4, 2, 2, 0, 0,
        ...
        [13, 11, 9, 8, 8, 9, 7, 6, 6, 5, 4, 4, 2, 2, 0, 0, 
            ...
            18, 18, 17, 17, 16, 15, 14, 13, 14, 13, 12, 12, 11, 10, 9, 8, 12, 11, 10, 10, 9, 8, 7, 6, 5, 5, 5, 4, 2, 2, 0, 0, 
            0, 0],
        ],
        'Classification_threshold': [50, 100, 75, 32, 500, 75, 50],
        'Vul_threshold': [50, 99, 75, 32, 465, 75, 49],
        'Nv_threshold': [50, 101, 76, 32, 476, 76, 50],
        'Accuracy': 0.0,
        'Expectation': 0.0 }, index=['Work',
            'Woolsey',
            'Kleinman',
